...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Event::factory()->create(['title' => 'PADDLE', 'description' => 'If you like paddle tennis and want to meet new people, come to this padel meeting on September 5, 2022 at the Oviedo sports center', 'img' => 'https://cdn.pixabay.com/photo/2021/09/10/06/47/paddle-tennis-6612340_1280.jpg', 'spaces' => 10, 'event_date' => '2022-09-05']);

        Event::factory()->create(['title' => 'CHESS TOURNAMENT', 'description' => 'Next September 5, we will celebrate a Chess tournament, if you are willing to participate, sign up now!. It will be held in the house of Culture of Aviles  ', 'img' => 'https://cdn.pixabay.com/photo/2018/11/20/13/36/composing-3827454_1280.jpg', 'spaces' => 8, 'event_date' => '2022-09-05']);

        Event::factory()->create(['title' => 'INITIATION TO BOXING', 'description' => 'We will meet a group of people to enjoy boxing. The event will be held at the Osito Feliz gym in the town of Gijón', 'img' => 'https://cdn.pixabay.com/photo/2012/10/25/23/32/boxing-62867_1280.jpg', 'spaces' => 8, 'event_date' => '2022-09-04']);

        Event::factory()->create(['title' => 'FOOTBALL MATCH FOR THE 3RD AGE', 'description' => 'We will celebrate a soccer game on Sunday September 12, we all have the right to enjoy.', 'img' => 'https://i.postimg.cc/9Fys99cw/active-senior-men-thanking-each-other-after-match-men-with-grey-hair-in-sport-clothes-standing-in-ro.jpg', 'spaces' => 14, 'event_date' => '2022-09-12']);
        ...
        Event::factory()->create(['carousel' => 1, 'title' => 'TENNIS PRACTICE', 'description' => 'If you want to practice tennis, you can stay with us and together we will learn new techniques that will help you to be more professional and enjoy a pleasant afternoon. We meet at the Gijón Sports Center.', 'img' => 'https://cdn.pixabay.com/photo/2014/03/16/13/43/kim-clijsters-288567_1280.jpg', 'spaces' => 6, 'event_date' => '2022-11-3']);

        Event::factory()->create(['carousel' => 1, 'title' => 'AN 5 KM MINI-MARATHON', 'description' => 'We will celebrate a 5 km mini-marathon through the town of Gijón. the meeting point will be the town hall square.', 'img' => 'https://cdn.pixabay.com/photo/2015/10/03/21/58/sport-970443_1280.jpg', 'spaces' => 20, 'event_date' => '2022-12-5']);
        ...
        Event::factory()->create(['title' => 'THE BEAR TRAIL', 'description' => 'On Asturias day, a group of people will go on the Ruta del Oso. It is a very beautiful route where you can admire the Asturian nature and with some luck see a bear.', 'img' => 'http://naturapps.es/blog/wp-content/uploads/senda_oso_naturapps.jpg', 'spaces' => 10, 'event_date' => '2022-09-8']);
